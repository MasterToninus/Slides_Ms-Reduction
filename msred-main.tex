...
A well-known result in symplectic geometry, known as Marsden–Weinstein–Meyer symplectic reduction theorem, states that (MW ...)

Such a result can be extended in a purely algebraic setting to the case of a singular moment map according to the so-called Sniaticki-Weinstein reduction scheme.
